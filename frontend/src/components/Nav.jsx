...
export default function Nav() {
  ...
  return (
    <nav className={styles.nav}>
      ...
      <button className={linkClass('/search')} onClick={() => navigate('/search')}>Search</button>
      ...
      {navidromeUrl && (
        <a className={styles.link} href={`${navidromeUrl}/app/`} target="_blank" rel="noreferrer">Navidrome ↗</a>
      )}
